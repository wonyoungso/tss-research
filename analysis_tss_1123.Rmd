...
model_3 <- feols(security_deposit ~ view_mode * score, data = tss_df_sd, cluster = tss_df_sd$user_id)
model_3 %>% summary()

model_4 <- feols(security_deposit ~ view_mode * score + income_linear_cent + okay_blanket_policy_yes_cent + nou_2_4_units_cent + nou_4_10_units_cent + nou_10_50_units_cent + nou_50_units_cent + race_asian_cent + race_black_cent + race_hispanic_cent + race_native_cent + race_other_cent + gender_female_cent, data = tss_df_sd, cluster = tss_df_sd$user_id)
